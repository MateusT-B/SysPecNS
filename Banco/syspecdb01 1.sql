...
INSERT INTO `clientes` VALUES (26,'Alessandro','50030020001','11962663733','ale@gmail.com','2024-09-05','2024-09-05 14:34:03','');
...
INSERT INTO `estoques` VALUES (1,0.00,'2024-09-03 03:00:00'),(2,0.00,'2024-09-03 03:00:00'),(3,0.00,'2024-09-03 03:00:00'),(4,0.00,'2024-09-03 03:00:00'),(5,0.00,'2024-09-03 03:00:00'),(6,0.00,'2024-09-03 03:00:00'),(7,0.00,'2024-09-03 03:00:00'),(8,0.00,'2024-09-03 03:00:00');
...
CREATE TABLE `produtofornecedor` (
  ...
  KEY `fkff_idx` (`fornecedores_id`),
  CONSTRAINT `fkff` FOREIGN KEY (`fornecedores_id`) REFERENCES `fornecedores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fkpf` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produtos` VALUES (1,'7894563120876','Parafuso para motor de arranque caixa 10un',9.98,'unidade',266,0.00,0.12,NULL,'2024-09-03 12:07:34'),(2,'7894564583876','Pretinho pneus',11.98,'unidade',264,0.00,0.20,NULL,'2024-09-03 12:07:34'),(3,'7894564488876','Pastilha de freio para Fusca caixa com jogo',25.79,'unidade',266,0.00,0.12,NULL,'2024-09-03 12:07:34'),(4,'7894647680876','Pneu Pirelli 14 175x60',529.74,'unidade',261,0.00,0.00,NULL,'2024-09-03 12:07:34'),(5,'7894564159876','Oleo Lubrax 5w30 Litro',34.98,'unidade',265,0.00,0.15,NULL,'2024-09-03 12:07:34'),(6,'7897521120876','Limpador de parabrisas Dyna DX18 par',65.64,'unidade',263,0.00,0.00,NULL,'2024-09-03 12:07:34'),(7,'7894541258876','Bateria Moura 60A',463.98,'unidade',266,0.00,0.05,NULL,'2024-09-03 12:07:34'),(8,'7894563125874','Radiador Denso Fusca 66',897.98,'unidade',266,0.00,0.00,NULL,'2024-09-03 12:07:34');
...
INSERT INTO `usuarios` VALUES (1019,'Paulo Santos','paulo@gmail.com','827ccb0eea8a706c4c34a16891f84e7b',1,''),(1021,'Alessandro','Nandok1012@gmail.com','202cb962ac59075b964b07152d234b70',2,''),(1022,'Helena Rodrigues Santana','helena@gmail.com','202cb962ac59075b964b07152d234b70',1,''),(1023,'Igor Rodrigues Sant\'ana','Igor@gmail.com','202cb962ac59075b964b07152d234b70',1,''),(1024,'cleber Pinto','cleber@senacsp.edu.br','81dc9bdb52d04dc20036dbd8313ed055',2,'');
...
-- Dump completed on 2024-09-06  8:10:55
